...
export default function LinkBar()
{
        ...
        async function fetchData() {
            ...
            if(cookie)
            {
                const instance = axios.create({
                    ...
                    timeout: 1000,
                    headers: {'Access-Control-Allow-Origin' : "http://localhost:3000/", 'Access-Control-Allow-Credentials' : true, 'Authorization' : "Bearer " + cookie}
                  })
    ...
    return(
         <div>
           {loadedUser && <div> <nav class="navbar navbar-expand-lg navbar-light bg-dark">
            <Navbar.Brand>
            <Animation/>
            </Navbar.Brand>
